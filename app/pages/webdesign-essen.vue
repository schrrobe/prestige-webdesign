<template>
  <div class="min-h-screen bg-gradient-to-br from-dark-900 via-dark-800 to-dark-900">
    ...
    <section class="section-padding pt-32 pb-20 bg-gradient-to-br from-primary-900/10 to-dark-900">
      <div class="container-narrow">
        ...
        <p class="text-xl text-gray-300 mb-4 max-w-3xl leading-relaxed">
          Moderne Webagentur für Essen und die ganze Metropole Ruhr. Prestige Webdesign schafft professionelle Websites und digitale Lösungen, die Essener Unternehmen zum Wachstum verhelfen.
        </p>
    ...
    <section class="section-padding bg-dark-850">
      <div class="container-narrow">
        <h2 class="font-display text-4xl font-bold mb-12 text-gradient">
          Webdesign Essen: Digital erfolgreich in der Metropole Ruhr
        </h2>
    ...
    <section class="section-padding">
      <div class="container-narrow">
        <h2 class="font-display text-4xl font-bold mb-12 text-gradient">
          Webdesign & Digitale Lösungen für Essen
        </h2>
    ...
    <section class="section-padding bg-dark-850">
      <div class="container-narrow">
        <h2 class="font-display text-4xl font-bold mb-12 text-gradient">
          Was Sie mit professionellem Webdesign in Essen erreichen
        </h2>
        <div class="space-y-6">
          <div class="glass-card p-8 rounded-xl flex items-start gap-6">
            <div class="text-4xl font-display font-bold text-primary-400 flex-shrink-0">01</div>
            <div>
              <h3 class="font-display text-xl font-bold mb-2 text-white">Erhöhte Online-Sichtbarkeit</h3>
              <p class="text-gray-400">
          ...
          <div class="glass-card p-8 rounded-xl flex items-start gap-6">
            <div class="text-4xl font-display font-bold text-primary-400 flex-shrink-0">02</div>
            <div>
              <h3 class="font-display text-xl font-bold mb-2 text-white">Glaubwürdigkeit & Vertrauen</h3>
              <p class="text-gray-400">
          ...
          <div class="glass-card p-8 rounded-xl flex items-start gap-6">
            <div class="text-4xl font-display font-bold text-primary-400 flex-shrink-0">03</div>
            <div>
              <h3 class="font-display text-xl font-bold mb-2 text-white">Mehr Anfragen & Umsatz</h3>
              <p class="text-gray-400">
          ...
          <div class="glass-card p-8 rounded-xl flex items-start gap-6">
            <div class="text-4xl font-display font-bold text-primary-400 flex-shrink-0">04</div>
            <div>
              <h3 class="font-display text-xl font-bold mb-2 text-white">Competitive Advantage</h3>
              <p class="text-gray-400">
          ...
          <div class="glass-card p-8 rounded-xl flex items-start gap-6">
            <div class="text-4xl font-display font-bold text-primary-400 flex-shrink-0">05</div>
            <div>
              <h3 class="font-display text-xl font-bold mb-2 text-white">24/7 Kundenakquisition</h3>
              <p class="text-gray-400">
          ...
          <div class="glass-card p-8 rounded-xl flex items-start gap-6">
            <div class="text-4xl font-display font-bold text-primary-400 flex-shrink-0">06</div>
            <div>
              <h3 class="font-display text-xl font-bold mb-2 text-white">Datengestützte Entscheidungen</h3>
              <p class="text-gray-400">
