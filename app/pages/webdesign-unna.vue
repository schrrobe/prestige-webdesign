<template>
  <div>
    ...
    <section class="section-padding relative overflow-hidden bg-dark-800/30">
      <div class="container-narrow mx-auto relative">
        <h2 class="text-3xl md:text-4xl font-display font-semibold text-white mb-10">
          Webdesign in Unna mit Fokus auf <span class="text-gradient">Sichtbarkeit und Vertrauen</span>
        </h2>
    ...
    <section class="section-padding relative overflow-hidden bg-dark-800/30">
      <div class="container-narrow mx-auto relative">
        <h2 class="text-3xl md:text-4xl font-display font-semibold text-white mb-10">
          Ihre <span class="text-gradient">Vorteile</span> mit einer starken Website in Unna
        </h2>
        <div class="grid md:grid-cols-3 gap-8">
          <div class="glass-card p-8">
            <div class="text-primary-300 text-4xl font-display font-semibold mb-4">01</div>
            <h3 class="text-xl font-semibold text-white mb-3">Regionale Auffindbarkeit</h3>
            <p class="text-dark-300">
          ...
          <div class="glass-card p-8">
            ...
            <h3 class="text-xl font-semibold text-white mb-3">Bessere Nutzererfahrung</h3>
            <p class="text-dark-300">
          ...
          <div class="glass-card p-8">
            ...
            <h3 class="text-xl font-semibold text-white mb-3">Mehr qualifizierte Kontakte</h3>
            <p class="text-dark-300">
