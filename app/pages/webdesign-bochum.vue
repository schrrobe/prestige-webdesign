<template>
  <div class="min-h-screen bg-gradient-to-br from-dark-900 via-dark-800 to-dark-900">
    ...
    <section class="section-padding pt-32 pb-20 bg-gradient-to-br from-primary-900/10 to-dark-900">
      <div class="container-narrow">
        ...
        <p class="text-xl text-gray-300 mb-4 max-w-3xl leading-relaxed">
          Professionelle Webseiten und digitale Strategien für Bochumer Unternehmen. Prestige Webdesign schafft moderne Online-Lösungen, die Ihr Business in der aufstrebenden Stadt an der Ruhr erfolgreich macht.
        </p>
    ...
    <section class="section-padding bg-dark-850">
      <div class="container-narrow">
        <h2 class="font-display text-4xl font-bold mb-12 text-gradient">
          Webdesign Bochum: Digital durchstarten in der Wissensstadt
        </h2>
    ...
    <section class="section-padding">
      <div class="container-narrow">
        <h2 class="font-display text-4xl font-bold mb-12 text-gradient">
          Webdesign & Digital-Services für Bochum
        </h2>
    ...
    <section class="section-padding bg-dark-850">
      <div class="container-narrow">
        <h2 class="font-display text-4xl font-bold mb-12 text-gradient">
          Warum Bochumer Unternehmen auf uns vertrauen
        </h2>
        <div class="grid md:grid-cols-2 gap-6">
          <div class="glass-card p-8 rounded-xl">
            <div class="text-4xl font-display font-bold text-primary-400 mb-4">01</div>
            <h3 class="font-display text-xl font-bold mb-3 text-white">Lokale Expertise</h3>
            <p class="text-gray-400">
          ...
          <div class="glass-card p-8 rounded-xl">
            ...
            <h3 class="font-display text-xl font-bold mb-3 text-white">Maßgeschneiderte Lösungen</h3>
            <p class="text-gray-400">
          ...
          <div class="glass-card p-8 rounded-xl">
            ...
            <h3 class="font-display text-xl font-bold mb-3 text-white">Ergebnisorientierung</h3>
            <p class="text-gray-400">
          ...
          <div class="glass-card p-8 rounded-xl">
            ...
            <h3 class="font-display text-xl font-bold mb-3 text-white">Langfristige Partnerschaften</h3>
            <p class="text-gray-400">
          ...
          <div class="glass-card p-8 rounded-xl">
            ...
            <h3 class="font-display text-xl font-bold mb-3 text-white">Transparente Kommunikation</h3>
            <p class="text-gray-400">
          ...
          <div class="glass-card p-8 rounded-xl">
            ...
            <h3 class="font-display text-xl font-bold mb-3 text-white">Modernes Tech-Stack</h3>
            <p class="text-gray-400">
